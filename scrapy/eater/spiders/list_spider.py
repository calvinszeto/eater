...
class ListSpider(Spider):
    ...
    start_urls = [
        "http://localhost:8050/render.html?url=http://houston.eater.com/archives/2014/01/07/the-essential-38-houston-restaurants-january-2014-1.php&timeout=3&wait=0.5"
    ]
